...
The purpose of this role is to install and configure vagrant on your system.
...
- vagrant_parameter: Description of values. [default: value]
...
- name: vagrant
  ...
  roles:
    ...
    - role: robertdebock.vagrant
      vagrant_parameter: value
```

To install this role:
- Install this role individually using `ansible-galaxy install robertdebock.vagrant`

Sample roles/requirements.yml: (install with `ansible-galaxy install -r roles/requirements.yml
```
---
- name: robertdebock.bootstrap
- name: robertdebock.vagrant
```
